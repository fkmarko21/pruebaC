...
namespace proyectoMarco.Models
{
    public class CiudadsController : Controller
    {
        ...
        {
            ViewBag.idRegion = new SelectList(db.Region, "id", "nombre");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "id,nombre,idRegion")] Ciudad ciudad)
        {
            ...
            ViewBag.idRegion = new SelectList(db.Region, "id", "nombre", ciudad.idRegion);
            return View(ciudad);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,nombre,idRegion")] Ciudad ciudad)
        {
            if (ModelState.IsValid)
            {
